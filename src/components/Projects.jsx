...
function FeaturedProjectCard({ project, cardVariants }) {
  return (
    <motion.div
      ...
      className="bg-surface-raised rounded-xl2 overflow-hidden border border-border-subtle hover:border-accent transition-all duration-300 flex flex-col md:flex-row md:col-span-2 lg:col-span-3"
    >
      <div className="md:w-2/5 p-6 flex flex-col">
        {project.embedUrl ? (
          ...
          <div className="h-40 md:h-full flex items-center justify-center bg-gradient-to-br from-accent-from/10 to-accent-to/10 rounded-lg">
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          {project.tech.map((t) => (
            <span
              key={t}
              className="bg-surface-elevated text-text-secondary text-xs px-2 py-1 rounded"
            >
              {t}
            </span>
          ))}
...
function ProjectCard({ project, cardVariants }) {
  return (
    <motion.div
      variants={cardVariants}
      className="bg-surface-raised rounded-xl2 overflow-hidden border border-border-subtle hover:border-accent transition-all duration-300 flex flex-col"
    >
      {/* Icon header */}
