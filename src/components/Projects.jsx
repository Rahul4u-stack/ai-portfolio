    ...
    <div className={`${className} flex items-center gap-4 shrink-0`}>
      {project.github && (
        <a
          ...
          className="text-text-muted hover:text-accent-text transition-colors duration-200 flex items-center gap-1.5 text-sm"
        >
  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-1 lg:flex-none">
        ...
        <p className="text-accent-text text-sm font-medium mb-3">{project.subtitle}</p>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="font-mono text-accent-text text-xs mt-1">{project.metric}</p>
      </div>
